...
export default function Flourishing() {
  return (
    ...
    <div className="flex justify-center items-center px-16 py-9 bg-white rounded-[32px] max-md:px-5">
      <div className="w-full max-w-[908px] max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col max-md:gap-0">
          <div className="flex flex-col w-[42%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col self-stretch my-auto max-md:mt-10">
              <h1 className="text-6xl tracking-tighter text-blue-600 leading-[61px] max-md:text-4xl max-md:leading-10">
