            ...
            <div className="flex flex-col w-full max-md:ml-0 max-md:w-full">
              <div className="flex flex-col self-stretch my-auto max-md:mt-10">
                <h1 className="text-6xl font-kuano tracking-tighter text-blue-600 leading-[61px] max-md:text-4xl max-md:leading-10">
                  We are the <span className="text-blue-600">Flourishing</span>{" "}
                  Church
                </h1>
                <p className="mt-3.5 text-base tracking-normal leading-6 text-black">
                  Who we are Who we are Who we are Who we areWho we areWho we
                  are Who we are Who we areWho we are Who we areWho we areWho we
                  are
                </p>
              </div>
            </div>
