...
export default function MyExperience() {
  return (
    <>
    {/* <div className="flex flex-col pt-6 pb-20 px-16 text-white bg-blue-600 rounded-3xl border-4 border-white border-solid"> */}
    <section className="flex justify-center items-center pt-6 pr-10 text-white bg-blue-600 rounded-3xl px-16  max-md:px-5 ">
    <img
      loading="lazy"
    ...
    <div className="flex flex-col self-center mt-2.5 w-full max-w-[1017px] max-md:max-w-full">
      <header className="flex gap-5 text-5xl tracking-tighter leading-[51px] max-md:flex-wrap max-md:max-w-full max-md:text-4xl max-md:leading-10">
        <h1 className="flex-auto max-md:max-w-full max-md:text-4xl max-md:leading-10">
      ...
      <section className="flex justify-center items-center px-16 py-20 mt-6 bg-blue-700 rounded-3xl max-md:px-5 max-md:max-w-full">
