      ...
      <div className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
        <div className="flex flex-col grow items-start pt-14 pl-14 mx-auto w-full text-base tracking-normal text-black bg-white rounded-2xl max-md:mt-8">
          ...
          <div className="flex gap-4 pr-10 mt-6 text-blue-600 leading-[143%] max-md:pr-5">
            ...
            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/96bd85029765cd888c05633dd5526ac7e09887b38d22ea62d41cba9fb2dc6d37?apiKey=873e47fe7796454e93671642132d9742&" alt="" className="shrink-0 w-6 aspect-square" />
          </div>
          <img src={image} alt={imageAlt} className="self-end mt-5 max-w-full aspect-[0.73] w-[223px]" />
        </div>
      </div>
    );
  }
export default function Stream() {
    ...
    const socialData = [
        ...
        },
        {
          ...
          description: "Who we are Who we areWho we areWho we areWho we are", 
          ctaText: "Join us now",
          image: "https://cdn.builder.io/api/v1/image/assets/TEMP/227424a92863363e9df6b903893496e228a7aab26f9f60eee76656220b93556a?apiKey=873e47fe7796454e93671642132d9742&",
