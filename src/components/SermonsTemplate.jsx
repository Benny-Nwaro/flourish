import { HeadPhoneIcon, SearchIcon } from "../svg/svg";
...
function CardTemplate({ img, title, audioLink, downloadLink }) {
  return (
...
export default function SermonsPage() {
  return (
    <section className="flex px-[20px] min-[500px]:px-[30px] md:px-[80px] xl:px-[150px] py-[150px]">
