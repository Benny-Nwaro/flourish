...
function HeroImage({ src, className }) {
  return (
    <img
      ...
      src={src}
      alt="Hero"
      className={`mt-16 mb-6 w-full rounded-2xl border-white border-solid aspect-[1.43] border-[14px] max-w-[1149px] max-md:mt-10 max-md:max-w-full ${className}`}
    />
  );
}
...
export default function Location() {
  return (
    <div className="flex flex-col bg-slate-200 rounded-2xl">
      {/* <ProfileImage src="ext_0}}" /> */}
      <main className="flex justify-center items-center px-32 rounded-2xl w-full max-md:px-5 max-md:mt-10 max-md:max-w-full">
