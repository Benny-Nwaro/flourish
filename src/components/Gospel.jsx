          ...
          <div className="flex flex-col max-md:max-w-full">
            ...
            <div className="flex flex-col self-end px-5 mt-2 max-w-full  max-md:mt-10">
              ...
              <p className="mt-7 text-base tracking-normal leading-6 text-black max-md:max-w-full">
                Who we are Who we are Who we are Who we are Who we are Who we
                are Who we are Who we are Who we are Who we areWho we are Who we
                are Who we are Who we are Who we are Who we areWho we are Who we
                are Who we are Who we are
              </p>
            </div>
          </div>
          <img
