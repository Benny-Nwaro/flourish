...
export default function BlogsTop() {
  return (
    ...
    Blog
      ...
      <article className="max-w-full pb-16 mt-5 ">
      <p className="text-base tracking-normal leading-6 text-black ">
        Who we are Who we are Who we are Who we are Who we are Who we are Who we are Who we are Who we are Who we are Who we are Who we are Who we are Who we are Who we are Who we are Who we are Who we are Who we are Who we are
      </p>
    </article>
    </section>
