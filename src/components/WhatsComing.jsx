...
const EventCard = ({ image, title, date, location, time, description }) => (
    <div className="flex flex-col   text-base   hover:shadow-2xl tracking-normal leading-6 text-black max-md:max-w-full ">
...
export default function WhatsComing() {
  return (
    <div className='flex flex-col  bg-white'>
      ...
      <div className="justify-center px-8  ml-32 w-28 py-5 mt-4  text-sm font-bold tracking-normal leading-3 text-blue-600 whitespace-nowrap bg-blue-600 bg-opacity-10 rounded-[65.48px] max-md:px-8 max-md:ml-2.5">
        Events
      </div>
        

    <h1 className="mt-4  px-32 text-7xl tracking-tighter font-kuano text-black leading-[76.67399999999999px] max-md:max-w-full max-md:text-4xl max-md:px-5">What's Coming</h1>

    <p className="mt-4  px-32 w-3/5 justify-center text-base tracking-normal leading-6 font-serif text-black  max-md:w-4/5 max-md:px-5">
    ...
    <div className='px-32 mt-8 mb-8 max-md:px-5 bg-white'>
<div class="flex  overflow-hidden space-x-8 group">
