...
function AboutUs() {
  ...
  function Heading() {
    return (
      <h1 className="mt-5 text-7xl tracking-tighter leading-[74px] max-md:max-w-full max-md:text-4xl max-md:leading-10">
...
export default function WeFlourish() {
  return (
    <section className="flex justify-center items-center pt-10 px-64 pb-20  max-md:px-5 bg-slate-200">
    <div className="flex flex-col items-start px-16 pt-20 pb-20 text-blue-600 bg-white rounded-3xl max-md:px-5">
      <div className="flex flex-col ml-14 max-w-full ">
        <AboutUs />
        <Heading />
        <Description />
      </div>
