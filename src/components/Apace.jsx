  ...
  return (
    ...
    <div className="mt-20 mb-12 w-full max-w-[1112px] max-md:my-10 max-md:max-w-full">
      <div className="flex gap-5 max-md:flex-col max-md:gap-0">
        ...
        <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/bf05374ca2517e471802c359e723d22a78d1b9bca2317847e5189ff39e2f4877?apiKey=873e47fe7796454e93671642132d9742&"
              alt="Pastor Ama Chinecherem Ebenezer"
              className="mt-2.5 w-full aspect-[0.9] max-md:mt-10 max-md:max-w-full"
            /></div>
        <div className="flex flex-col ml-5 w-[46%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col grow self-stretch text-black max-md:mt-10 max-md:max-w-full">
