...
<div className="flex justify-center flex-col items-center w-full self-center pt-10 pb-20 mt-16  bg-blue-600 rounded-3xl border-4 border-white border-solid max-w-[1148px] max-md:pr-5 max-md:mt-10 max-md:max-w-full">
      ...
      <form className='max-md:w-full max-md:px-16 max-sm:px-16'>
        ...
        <input type="email"  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-2xl focus:ring-blue-500 mb-5 focus:border-blue-500 block w-full p-2.5 ml-50 dark:w-64 dark:mx-40 dark:mr-40 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="you.you@mail.com" required  
              id="email"
              onChange={(e) => setEmail(e.target.value)} />
    

        
            <input type="tel" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-2xl focus:ring-blue-500 mb-5 focus:border-blue-500 block w-full p-2.5 ml-50 dark:w-64 dark:mx-40 dark:mr-40 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="phone number" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" required  
              id="phone"
